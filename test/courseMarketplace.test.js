...
contract('CourseMarketplace', accounts => {
  ...
  describe('Activate the purchased course', () => {
    ...
    it('should have "activated" state', async () => {
      ...
      assert.equal(course.state, expectedState, 'The course should have been activated.')
    })
  })
  ...
  describe('Transfer ownership', () => {
    ...
    it('should transfer ownership to 3rd address from "accounts"', async () => {
      ...
      currentOwner = accounts[2];
      assert.equal(owner, currentOwner, 'Contract owner is not the second accound')
    })
    ...
    it('should transfer ownership back to initial contract owner', async () => {
      ...
      const owner = await _contract.getContractOwner()
      assert.equal(owner, contractOwner, 'Contract owner is not the second accound')
    })
  })
